...
Revision ID: 0aeb82f525e7
Revises: fba3698df8f7
Create Date: 2023-05-15 14:03:23.948535
...
revision = '0aeb82f525e7'
down_revision = 'fba3698df8f7'
branch_labels = None
depends_on = None
...
def upgrade_pyduck():
    ...
    sa.Column('created_at', sa.String(), nullable=False),
    sa.Column('question_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['question_id'], ['question.id'], name=op.f('fk_vote_question_id_question')),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_vote_user_id_user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_vote')),
    sa.UniqueConstraint('user_id', 'target', 'target_id', name=op.f('uq_vote_user_id_target_target_id'))
    )
    with op.batch_alter_table('vote', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_vote_target'), ['target'], unique=False)
...
def downgrade_pyduck():
    ...
    with op.batch_alter_table('vote', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_vote_target'))

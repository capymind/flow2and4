...
Revision ID: abf3b50bc14c
Revises: 2565a0944267
Create Date: 2023-05-18 17:39:41.326095
...
revision = 'abf3b50bc14c'
down_revision = '2565a0944267'
branch_labels = None
depends_on = None
...
def upgrade_pyduck():
    ...
    sa.Column('notification_value', sa.String(), nullable=True),
    ...
    sa.UniqueConstraint('user_id', 'notification_type', 'notification_value', 'notification_target_id', name=op.f('uq_notification_user_id_notification_type_notification_value_notification_target_id'))
    )
    ...
    sa.UniqueConstraint('user_id', 'action_type', 'action_value', 'target_id', name=op.f('uq_user_action_user_id_action_type_action_value_target_id'))
    )
